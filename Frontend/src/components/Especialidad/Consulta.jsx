...
export default function ConsultaServicios({servicios , onActualizar}){
    ...
    const tbody =  servicios.map((servicio) => (
            <tr key={servicio.id}>
                ...
                <td>
                 {
                     (<button className="btn btn-sm btn-secondary"  onClick={()=>{onActualizar(servicio)}}>Actualizar</button>)   
                 }  
